      ...
      <div>
        ...
        <el-table v-loading="loading" :data="tableData" border max-height="705" style="width: 100%">
          ...
          <el-table-column :filter-method="filterTag" :filters="[
            ...
            { text: '通过', value: '通过' },
            { text: '驳回', value: '驳回' },
          ]" filter-placement="bottom-end" label="申请状态" prop="state" sortable width="130px">
          ...
          <el-dialog v-model="dialogVisible" title="操作" width="30%" @close="cancel">
            <el-form ref="form" :model="form" :rules="rules" label-width="120px">
              ...
              <el-form-item label="申请时间" prop="applyTime" style="margin-top: 27px">
                <el-date-picker v-model="form.applyTime" clearable disabled placeholder="选择时间" style="width: 50%"
              ...
              <el-form-item label="处理时间" prop="finishTime" style="margin-top: 27px">
                <el-date-picker v-model="form.finishTime" clearable placeholder="选择时间" style="width: 50%" type="datetime"
