      ...
      <div>
        ...
        <el-table v-loading="loading" :data="tableData" border max-height="705" style="width: 100%">
              ...
              <el-form inline label-position="left">
                <el-form-item label="一号床位" class="item">
                  <template #default="scope">
                    <el-tag v-if="props.row.firstBed != null" disable-transitions type="primary">{{ props.row.firstBed }}
                    </el-tag>
                ...
                <el-form-item label="二号床位" class="item">
                  <template #default="scope">
                    <el-tag v-if="props.row.secondBed != null" disable-transitions type="primary">{{ props.row.secondBed
                    }}
                    </el-tag>
                    <div class="el-form--inline-icon">
                ...
                <el-form-item label="三号床位" class="item">
                  <template #default="scope">
                    <el-tag v-if="props.row.thirdBed != null" disable-transitions type="primary">{{ props.row.thirdBed }}
                    </el-tag>
                    <div class="el-form--inline-icon">
                ...
                <el-form-item label="四号床位" class="item">
                  <template #default="scope">
                    <el-tag v-if="props.row.fourthBed != null" disable-transitions type="primary">{{ props.row.fourthBed
                    }}
                    </el-tag>
                    <div class="el-form--inline-icon">
          ...
          <el-table-column :filter-method="filterTag" :filters="[
            ...
            { text: 3, value: 3 },
            { text: 4, value: 4 },
          ]" filter-placement="bottom-end" label="已住人数" prop="currentCapacity" sortable />
          <!--      操作栏-->
