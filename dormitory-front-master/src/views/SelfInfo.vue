<template>
  <div>
    ...
    <el-card class="custom-card" style="margin: 15px; min-height: calc(100vh - 111px)">
      <div style="display: flex">
        <div style="margin-left: 50px;margin-top: 20px">
          <!-- <div>
            <el-upload :on-success="uploadSuccess" :show-file-list="false" action="http://localhost:9090/files/upload/"
              class="upload-demo">
              <div class="AvatarDiv">
        ...
        <!-- <div style="margin-left: 100px">
          <img alt="" src="../../public/picture2.png" style="width:800px">
        </div> -->
      </div>
      <div>
        <!--      弹窗-->
