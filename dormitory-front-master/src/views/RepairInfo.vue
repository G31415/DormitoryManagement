      ...
      <div>
        ...
        <el-table v-loading="loading" :data="tableData" border max-height="705" style="width: 100%">
          ...
          <el-table-column :filter-method="filterTag" :filters="[
            { text: '完成', value: '完成' },
            { text: '未完成', value: '未完成' },
          ]" filter-placement="bottom-end" label="订单状态" prop="state" sortable>
            <template #default="scope">
              <el-tag :type="scope.row.state === '完成' ? 'success' : 'info'" disable-transitions>{{ scope.row.state }}
              </el-tag>
            </template>
          </el-table-column>
          ...
          <el-dialog v-model="dialogVisible" title="操作" width="30%" @close="cancel">
            <el-form ref="form" :model="form" :rules="rules" label-width="120px">
              ...
              <el-form-item label="内容" prop="content">
                <el-input v-model="form.content" :autosize="{ minRows: 3, maxRows: 10 }" autosize clearable
              ...
              <el-form-item label="订单创建时间" prop="orderBuildTime" style="margin-top: 27px">
                <el-date-picker v-model="form.orderBuildTime" :disabled="buildTimeDisabled" clearable placeholder="选择时间"
              ...
              <el-form-item :style="finishTime" label="订单完成时间" prop="orderFinishTime" style="margin-top: 27px">
                <el-date-picker v-model="form.orderFinishTime" clearable placeholder="选择时间" style="width: 48%"
