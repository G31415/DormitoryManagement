<template>
  <div class="calendar">
    ...
    }" class="data-container" @touchend="touchEnd" @touchstart="touchStart" @touchmove.stop.prevent="touchMove">
      <section :style="{
        ...
        <div :style="{
          ...
          transitionDuration: `${needHeightAnimation ? transitionDuration : 0
            }s`,
        }" class="banner-area">
          <ul v-for="(monthItem, monthIndex) in allDataArr" :key="monthIndex" :style="{
